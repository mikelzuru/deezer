...
type SearcherClient interface {
	// Basic search
	Search(ctx context.Context, in *BasicSearchRequest, opts ...grpc.CallOption) (*BasicSearchResponse, error)
}
...
func (c *searcherClient) Search(ctx context.Context, in *BasicSearchRequest, opts ...grpc.CallOption) (*BasicSearchResponse, error) {
	out := new(BasicSearchResponse)
	err := c.cc.Invoke(ctx, "/info.Searcher/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearcherServer interface {
	// Basic search
	Search(context.Context, *BasicSearchRequest) (*BasicSearchResponse, error)
...
func (UnimplementedSearcherServer) Search(context.Context, *BasicSearchRequest) (*BasicSearchResponse, error) {
...
func _Searcher_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/info.Searcher/Search",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearcherServer).Search(ctx, req.(*BasicSearchRequest))
	}
